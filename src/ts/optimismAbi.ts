export const ovmTransactionChainAbi = [
  {
    inputs: [
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "address", name: "l1TxOrigin", type: "address" },
      ...
      {
        components: [
          { internalType: "bool", name: "isSequenced", type: "bool" },
          { internalType: "uint256", name: "queueIndex", type: "uint256" },
          { internalType: "uint256", name: "timestamp", type: "uint256" },
          { internalType: "uint256", name: "blockNumber", type: "uint256" },
