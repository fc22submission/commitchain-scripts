export const zkSyncAbi = [
  ...
  { anonymous: false, inputs: [], name: "ExodusMode", type: "event" },
  {
    anonymous: false,
    inputs: [
      {
      ...
      { indexed: false, internalType: "bytes", name: "fact", type: "bytes" },
    ],
    name: "FactAuth",
    type: "event",
  },
  ...
  },
  {
    inputs: [
      ...
      {
        components: [
          { internalType: "bytes32", name: "newStateHash", type: "bytes32" },
          { internalType: "bytes", name: "publicData", type: "bytes" },
          { internalType: "uint256", name: "timestamp", type: "uint256" },
          {
            components: [
              { internalType: "bytes", name: "ethWitness", type: "bytes" },
              {
                internalType: "uint32",
          ...
          { internalType: "uint32", name: "blockNumber", type: "uint32" },
          { internalType: "uint32", name: "feeAccount", type: "uint32" },
        ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint128", name: "_amount", type: "uint128" },
      { internalType: "uint32", name: "_nftCreatorAccountId", type: "uint32" },
      { internalType: "address", name: "_nftCreatorAddress", type: "address" },
      { internalType: "uint32", name: "_nftSerialId", type: "uint32" },
      { internalType: "bytes32", name: "_nftContentHash", type: "bytes32" },
  ...
  {
    inputs: [
      { internalType: "bytes", name: "_pubkeyHash", type: "bytes" },
